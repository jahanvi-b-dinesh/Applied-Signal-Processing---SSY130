...
legend('Position without noise', 'position with noise')
...
R = blkdiag(pdX.sigma^2, pdY.sigma^2);      % Noise covarience R
alpha = 1e-4;
Q = blkdiag(0, 1, 0, 1)*alpha;              % Noise covariance Q 
